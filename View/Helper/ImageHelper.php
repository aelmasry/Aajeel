...
class ImageHelper extends AppHelper {
    ...
    /**
     * @uses echo $this->Image->resize('myimage.jpg', 150, 150, true); 
    ...
    function resize($path, $width, $height, $aspect = true, $htmlAttributes = array(), $return = false) 
    {
        ...
        $relfile = $this->request->webroot . $this->themeWeb . IMAGES_URL . $this->cacheDir . '/' . $width . 'x' . $height . '_' . basename($path); // relative file
