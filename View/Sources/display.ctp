<div class="NewsBox">
<?php while (list(, $articel) = each($articels)) { ?>
<div class="NewsWrap">
    ...
    <div class="NewsData">
        ...
        <div class="NewsTitle">
                ...
                </a> &nbsp; <span><?php echo $this->Html->relativeTime($articel['Article']['created']); ?></span>
...
$(document).ready(function() {
    ...
    $(window).scroll(function() { //detect page scroll
        ...
        if($(window).scrollTop() + $(window).height() == $(document).height())  //user scrolled to bottom of the page?
        {
            ...
            $.post('<?php echo $this->Html->url(array('controller'=> $this->request->params['controller'], 'action'=> 'loadMore', $this->request->params['pass'][0]))?>',{'group_no': track_load}, function(data){
